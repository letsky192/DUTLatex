...
\committeeMemberOne{\Anon{ABC}}
\committeeMemberTwo{DE}
\committeeMemberThree{FGH}
\committeeMemberFour{IJK}
\committeeMemberFive{LM}

\defenseCandidate{硕士生}
\defenseLocation{大连理工大学综合教学1号楼301室}

% 声明页日期
\statementDateYear{年}
\statementDateMonth{月}
\statementDateDay{日}
